    ...
    if (username != "" && selected_subject != "") {
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response) {
                    $("#class_list_table").html(`<tr>
                    <th style="width: 100px">Roll no</th>
                    <th style="width: 40px">Attendance percent</th>
                </tr>`);
                    ...
                    var msg = "<div  class='alert alert-danger alert-dismissible fade show' role='alert'><strong>Unable to fetch, please select again</strong></div>";
